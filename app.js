! function (t) {
    ...
    new([class {
        constructor() {
            this.scroll = {
                ...
                target: 0,
                last: 0
            }, this.speed = 4, this.createRenderer(), this.createCamera(), this.createScene(), this.createGallery(), this.onResize(), this.createGeometry(), this.createMedias(), this.update(), this.addEventListeners()
        }
        createGallery() {
            this.gallery = document.querySelector(".outdated__gallery")
        }
        createRenderer() {
            this.renderer = new f({
                alpha: !0
        ...
        createMedias() {
            this.mediasElements = document.querySelectorAll(".outdated__gallery__figure"), this.medias = Array.from(this.mediasElements).map(t => new class {
                constructor({
                    element: t,
                    geometry: e,
                    gl: i,
        ...
        constructor() {
            this.scroll = {
                ...
                target: 0,
                last: 0
            }, this.speed = 4, this.createRenderer(), this.createCamera(), this.createScene(), this.createGallery(), this.createPost(), this.onResize(), this.createGeometry(), this.createMedias(), this.update(), this.addEventListeners()
        }
    ...
    const mt = document.querySelectorAll('img:not([src*=""])');
    let ft = 0;
